...
[EXTRA] = LAYOUT_tkl_ansi(
     ...
     KC_LSFT,                TG(NUMBERS_SYMBOLS), KC_X,         KC_C,         KC_V,      KC_B,     KC_LBRC,    KC_RBRC,    S(KC_LBRC),  S(KC_RBRC), KC_SLSH,              KC_RSFT,            KC_UP,
...
[NUMBERS_SYMBOLS] = LAYOUT_tkl_ansi(
     ...
     KC_LSFT,              TG(NUMBERS_SYMBOLS), KC_X,    KC_C,      KC_EUR,     KC_B,          KC_LBRC,      KC_RBRC,     S(KC_LBRC), S(KC_RBRC), KC_SLSH,                     KC_RSFT,             KC_UP,
     KC_LCTL,  KC_LOPTN,   KC_LCMMD,                               LAYER_CLEAR,                                                       KC_RCMMD,   KC_ROPTN,      MO(MAC_FN),   KC_RCTL,  KC_LEFT,  KC_DOWN,   KC_RGHT),
