...
[MAC_BASE] = LAYOUT_tkl_ansi(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               LT(4, KC_SPC),                                     KC_RCMMD,     KC_ROPTN, MO(MAC_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,   KC_RGHT),
...
[EXTRA] = LAYOUT_tkl_ansi(
     ...
     KC_CAPS,  KC_A,     LGUI_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,     KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_ENT,   KC_QUOT,              KC_ENT,
     KC_LSFT,            KC_Z,         KC_X,         KC_C,         KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,            KC_UP,
